...
import { API_URL_CATEGORIA, fetchAPIAsync, notificationSwal, eliminarSwal, editarSwal } from 'common/common';
...
const columns = [
  ...
  { id: 'description', label: 'Descripción', minWidth: 100, key: 2 }
];
...
export default function CategoriaPage() {
  ...
  async function updateItem() {
    ...
    const updatedData = {
      name: editedItem.edit_name,
      description: editedItem.edit_description,
    };
    if (ValidacionItemSave(updatedData) === false) {
      return;
    }
    editarSwal(API_URL_CATEGORIA, productId, updatedData, SearchFilter);
    handleCloseModal2();
  }
  ...
  return (
    <div>
      <div className="form">
        <Button onClick={handleOpenModal1} className='btn btn-info mb-3'>Registrar categoria</Button>
              ...
              <form>
                ...
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    value={editedItem.edit_description || ''}
                  />
                </div>
              </form>
            </div>
